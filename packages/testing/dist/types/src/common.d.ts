...
export type UserRole = 'super_admin' | 'org_admin' | 'doctor' | 'nurse' | 'technician' | 'pharmacist' | 'receptionist' | 'patient' | 'viewer';
...
export type OrganizationType = 'hospital' | 'clinic' | 'pharmacy' | 'laboratory' | 'imaging_center' | 'nursing_home' | 'home_health' | 'insurance' | 'government' | 'other';
...
export type DocumentType = 'medical_record' | 'lab_report' | 'imaging_report' | 'prescription' | 'consent_form' | 'insurance_claim' | 'billing_statement' | 'discharge_summary' | 'referral_letter' | 'policy_document' | 'other';
