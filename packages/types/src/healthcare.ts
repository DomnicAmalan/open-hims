...
export interface HealthcareRegulation {
  ...
  inheritsFrom?: string; // For state regulations inheriting from federal
}
...
export interface StateRegulation {
  ...
  stateName: string;
  regulations: HealthcareRegulation[];
  inheritsFrom: string; // Country or other state code
}
...
export interface HealthcareWorkflow {
  ...
  complianceRequirements: string[]; // Regulation IDs
  createdBy: string;
  createdDate: string;
  lastModified: string;
...
export interface WorkflowTransition {
  ...
  probability?: number; // for decision steps
}
