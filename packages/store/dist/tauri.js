...
export const createTauriStore = (options = {}) => {
    const { useFileStorage = false, fileName = 'hims-data.json', enableDevTools = process.env.NODE_ENV !== 'production', persistWhitelist = ['patients', 'config'], persistBlacklist = ['audit'], } = options;
